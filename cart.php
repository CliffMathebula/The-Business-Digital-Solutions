...
/**
 *  
 *Request cart action from the uri and perform delete one item
 *Or delete all items in cart array
 * 
 **/
...
<body class="animsition">
    ...
    <section class="cart bgwhite p-t-70 p-b-100">
        <div class="container">
                    ...
                    ?>
                        <table class="table-shopping-cart">
                            <tr class="table">
                                ...
                                <th class="column-6">
                                    <a id="btnEmpty" href="cart.php?action=empty" class="flex-c-m btn btn-sm bo-rad-23 hov1 text-white trans-0-4 btn btn-danger">
                            ...
                            ?>
                                <tr class="table-row">
                                    ...
                                    <td class="column-2 text-center">
                                        <?php echo "R " . $item["price_per_month"]; ?>
                                    </td>
                                    ...
                                    <td class="column-5">
                                        <?php echo "R " . number_format($item_price, 2); ?>
                                    </td>
                                    <td column="column-6">
                                        <div class="w-size17">
                                            <a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>">
                                                <img src="models/icon-delete.png" alt="Remove Item" /></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php
            ...
            <!-- Total -->
            <div class="bo8 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm bg-secondary">
