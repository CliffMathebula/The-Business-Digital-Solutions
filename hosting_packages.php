								...
								<div class="block2-overlay trans-0-4">
									<div class="block2-btn-addcart w-size1 trans-0-4">
										...
										<?php if (isset($_SESSION["cart_item"])) { ?>
											<input type="button" id="add_<?php echo $product_array[$key]["code"]; ?>" value="Update Cart" class="flex-c-m size4 bg-info bo-rad-23 hov1 s-text1 trans-0-4" onClick="cartAction('add','<?php echo $product_array[$key]["code"]; ?>')" />
										<?php } else {
										?>
											<input type="button" id="add_<?php echo $product_array[$key]["code"]; ?>" value="Add to cart" class="flex-c-m size4 bg-info bo-rad-23 hov1 s-text1 trans-0-4" onClick="cartAction('add','<?php echo $product_array[$key]["code"]; ?>')" />
